...
pub fn reduce_ast(ast: &Box<Ast>, env: &mut Env, stdouts: &mut Stdout) -> ValRes {
    ...
    match &ast.kind {
        ...
        AstKind::InfixLBracketEquals { left: l, right: r } => {
            comp_infix::reduce_lbracket_equals(&l, &r, &loc, env, stdouts)
        }
...
mod tests {
    ...
    mod comparison_infix {
        ...
        #[case::left_greater_than_right(
            // Represents `2 <= 1`.
            mkast!(prog loc str_loc!("", "2 <= 1"), vec![
                mkast!(infix InfixLBracketEquals, loc str_loc!("", "2 <= 1"),
                    left mkast!(num 2.0, loc str_loc!("", "2")),
                    right mkast!(num 1.0, loc str_loc!("2 <= ", "1")),
                ),
            ]),
        ...
        #[case::left_equal_to_right(
            // Represents `1 <= 1`.
            mkast!(prog loc str_loc!("", "1 <= 1"), vec![
                mkast!(infix InfixLBracketEquals, loc str_loc!("", "1 <= 1"),
                    left mkast!(num 1.0, loc str_loc!("", "1")),
                    right mkast!(num 1.0, loc str_loc!("1 <= ", "1")),
                ),
            ]),
        ...
        fn lbracket_equals(#[case] ast: Box<Ast>, #[case] expected: Value) {
            assert_eval!(&ast, expected);
        }
        ...
        #[case::str_and_num(
            // Represents `"사과" <= 1`.
            mkast!(prog loc str_loc!("", "\"사과\" <= 1"), vec![
                mkast!(infix InfixLBracketEquals, loc str_loc!("", "\"사과\" <= 1"),
                    left mkast!(string loc str_loc!("", "\"사과\""), vec![
                        mkstrseg!(Str, "사과", str_loc!("\"", "사과")),
                    ]),
                    right mkast!(num 1.0, loc str_loc!("\"사과\" <= ", "1")),
        ...
        #[case::num_and_str(
            // Represents `1 <= "사과"`.
            mkast!(prog loc str_loc!("", "1 <= \"사과\""), vec![
                mkast!(infix InfixLBracketEquals, loc str_loc!("", "1 <= \"사과\""),
                    left mkast!(num 1.0, loc str_loc!("", "1")),
                    right mkast!(string loc str_loc!("1 <= ", "\"사과\""), vec![
                        mkstrseg!(Str, "사과", str_loc!("1 <= \"", "사과")),
                    ]),
        ...
        #[case::bool_and_num(
            // Represents `참 <= 1`.
            mkast!(prog loc str_loc!("", "참 <= 1"), vec![
                mkast!(infix InfixLBracketEquals, loc str_loc!("", "참 <= 1"),
                    left mkast!(boolean true, loc str_loc!("", "참")),
                    right mkast!(num 1.0, loc str_loc!("참 <= ", "1")),
                ),
            ]),
        ...
        #[case::num_and_bool(
            // Represents `1 <= 참`.
            mkast!(prog loc str_loc!("", "1 <= 참"), vec![
                mkast!(infix InfixLBracketEquals, loc str_loc!("", "1 <= 참"),
                    left mkast!(num 1.0, loc str_loc!("", "1")),
                    right mkast!(boolean true, loc str_loc!("1 <= ", "참")),
                ),
            ]),
        ...
        #[case::closure_and_num(
            // Represents `함수 { 1 } <= 1`.
            mkast!(prog loc str_loc!("", "함수 { 1 } <= 1"), vec![
                mkast!(infix InfixLBracketEquals, loc str_loc!("", "함수 { 1 } <= 1"),
                    left mkast!(closure loc str_loc!("", "함수 { 1 }"),
                        params vec![],
                        body vec![
                            mkast!(num 1.0, loc str_loc!("함수 { ", "1"))
        ...
        #[case::num_and_closure(
            // Represents `1 <= 함수 { 1 }`.
            mkast!(prog loc str_loc!("", "1 <= 함수 { 1 }"), vec![
                mkast!(infix InfixLBracketEquals, loc str_loc!("", "1 <= 함수 { 1 }"),
                    left mkast!(num 1.0, loc str_loc!("", "1")),
                    right mkast!(closure loc str_loc!("1 <= ", "함수 { 1 }"),
                        params vec![],
                        body vec![
        ...
        fn wrong_type_lbracket_equals(#[case] ast: Box<Ast>, #[case] error: EvalError) {
            assert_eval_fail!(&ast, error);
        }
        ...
        #[case::left_greater_than_right(
            // Represents `2 >= 1`.
            mkast!(prog loc str_loc!("", "2 >= 1"), vec![
                mkast!(infix InfixRBracketEquals, loc str_loc!("", "2 >= 1"),
                    left mkast!(num 2.0, loc str_loc!("", "2")),
                    right mkast!(num 1.0, loc str_loc!("2 >= ", "1")),
                ),
            ]),
        ...
        #[case::left_equal_to_right(
            // Represents `1 >= 1`.
            mkast!(prog loc str_loc!("", "1 >= 1"), vec![
                mkast!(infix InfixRBracketEquals, loc str_loc!("", "1 >= 1"),
                    left mkast!(num 1.0, loc str_loc!("", "1")),
                    right mkast!(num 1.0, loc str_loc!("1 >= ", "1")),
                ),
            ]),
        ...
        fn rbracket_equals(#[case] ast: Box<Ast>, #[case] expected: Value) {
            assert_eval!(&ast, expected);
        }
        ...
        #[case::str_and_num(
            // Represents `"사과" >= 1`.
            mkast!(prog loc str_loc!("", "\"사과\" >= 1"), vec![
                mkast!(infix InfixRBracketEquals, loc str_loc!("", "\"사과\" >= 1"),
                    left mkast!(string loc str_loc!("", "\"사과\""), vec![
                        mkstrseg!(Str, "사과", str_loc!("\"", "사과")),
                    ]),
                    right mkast!(num 1.0, loc str_loc!("\"사과\" >= ", "1")),
        ...
        #[case::num_and_str(
            // Represents `1 >= "사과"`.
            mkast!(prog loc str_loc!("", "1 >= \"사과\""), vec![
                mkast!(infix InfixRBracketEquals, loc str_loc!("", "1 >= \"사과\""),
                    left mkast!(num 1.0, loc str_loc!("", "1")),
                    right mkast!(string loc str_loc!("1 >= ", "\"사과\""), vec![
                        mkstrseg!(Str, "사과", str_loc!("1 >= \"", "사과")),
                    ]),
        ...
        #[case::bool_and_num(
            // Represents `참 >= 1`.
            mkast!(prog loc str_loc!("", "참 >= 1"), vec![
                mkast!(infix InfixRBracketEquals, loc str_loc!("", "참 >= 1"),
                    left mkast!(boolean true, loc str_loc!("", "참")),
                    right mkast!(num 1.0, loc str_loc!("참 >= ", "1")),
                ),
            ]),
        ...
        #[case::num_and_bool(
            // Represents `1 >= 참`.
            mkast!(prog loc str_loc!("", "1 >= 참"), vec![
                mkast!(infix InfixRBracketEquals, loc str_loc!("", "1 >= 참"),
                    left mkast!(num 1.0, loc str_loc!("", "1")),
                    right mkast!(boolean true, loc str_loc!("1 >= ", "참")),
                ),
            ]),
        ...
        #[case::closure_and_num(
            // Represents `함수 { 1 } >= 1`.
            mkast!(prog loc str_loc!("", "함수 { 1 } >= 1"), vec![
                mkast!(infix InfixRBracketEquals, loc str_loc!("", "함수 { 1 } >= 1"),
                    left mkast!(closure loc str_loc!("", "함수 { 1 }"),
                        params vec![],
                        body vec![
                            mkast!(num 1.0, loc str_loc!("함수 { ", "1"))
        ...
        #[case::num_and_closure(
            // Represents `1 >= 함수 { 1 }`.
            mkast!(prog loc str_loc!("", "1 >= 함수 { 1 }"), vec![
                mkast!(infix InfixRBracketEquals, loc str_loc!("", "1 >= 함수 { 1 }"),
                    left mkast!(num 1.0, loc str_loc!("", "1")),
                    right mkast!(closure loc str_loc!("1 >= ", "함수 { 1 }"),
                        params vec![],
                        body vec![
        ...
        fn wrong_type_rbracket_equals(#[case] ast: Box<Ast>, #[case] error: EvalError) {
            assert_eval_fail!(&ast, error);
        }
    }
