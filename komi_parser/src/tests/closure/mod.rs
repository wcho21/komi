...
/// Failure cases: incomplete expressions.
#[rstest]
...
fn fail_incomplete(#[case] tokens: Vec<Token>, #[case] error: ParseError) {
    assert_parse_fail!(&tokens, error);
}

/// Failure cases: bad parameters
#[rstest]
...
fn fail_bad_params(#[case] tokens: Vec<Token>, #[case] error: ParseError) {
    assert_parse_fail!(&tokens, error);
}

/// Failure cases: empty body.
#[rstest]
...
fn fail_empty_body(#[case] tokens: Vec<Token>, #[case] error: ParseError) {
    assert_parse_fail!(&tokens, error);
}
